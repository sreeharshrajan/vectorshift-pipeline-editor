export const DraggableNode = ({ type, label, icon, collapsed }) => {
  ...
  return (
    ...
    >
      {/* Icon Wrapper */}
      <div
        className={`flex items-center justify-center transition-all duration-300 text-slate-500 dark:text-slate-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 group-hover:scale-110`}
      >
        {icon}
      </div>
      ...
      {/* Label */}
      <span
        className={`font-bold text-[11px] uppercase tracking-wider whitespace-nowrap overflow-hidden transition-all duration-300 text-slate-700 dark:text-slate-200 ${
